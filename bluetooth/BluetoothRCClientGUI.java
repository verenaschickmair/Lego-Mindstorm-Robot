...
public class BluetoothRCClientGUI {
	...
	private void initialize() {
		...
		JButton btnAutonom = new JButton("AUTONOM");
		btnAutonom.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					btrc.bluetoothAutonom();
				} catch (IOException e1) {
					System.out.println(e1.getMessage());
				}
			}
		});
		btnAutonom.setFont(new Font("Lucida Sans Unicode", Font.BOLD, 11));
		btnAutonom.setBounds(329, 11, 100, 80);
		panel.add(btnAutonom);
